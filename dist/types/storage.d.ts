export declare const setStorage: (options: wx.SetStorageOptions) => Promise<wx.BaseResponse>;
/**
 *
...
export declare const getStorage: (options: wx.GetStorageOptions) => Promise<wx.BaseResponse>;
/**
 * 从本地缓存中异步获取指定 key 对应的内容。
 * @param key 本地缓存中的指定的 key
 */
export declare function getStorageByKey(key: string): Promise<wx.BaseResponse>;
export declare const removeStorage: (options: wx.RemoveStorageOptions) => Promise<wx.BaseResponse>;
/**
 * 从本地缓存中异步移除指定 key 。
 * @param key 本地缓存中的指定的 key
 */
